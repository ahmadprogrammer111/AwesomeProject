      ...
      <View style={styles.container}>
         <View>
            ...
            <View>
               ...
               <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', borderRadius: 18, marginHorizontal: 30, height: '10%' }}>
                  <Icon name='search' size={20} color='#A5A5A5' style={{ padding: 10 }} />

                  <TextInput style={{ color: 'black', fontSize: 16, width: '83%' }} placeholder='Search' placeholderTextColor="#aaa" value={first} onChangeText={setfirst} />
               ...
               <View style={styles.Tabs}>
                  ...
                  <TouchableOpacity style={styles.tab3}>
               ...
               <View style={styles.img1}>
                  <Image style={{ height: 220, width: 140, }} source={require('../../../assets/images/2.png')} />
                  <Image style={{ height: 220, width: 140, }} source={require('../../../assets/images/7.png')} />
               </View>
